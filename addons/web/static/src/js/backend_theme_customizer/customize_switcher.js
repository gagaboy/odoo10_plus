...
var Theme = Widget.extend({
    ...
    active_select_tags: function () {
        ...
        $selects.each(function () {
            ...
            $options.each(function () {
                var $option = $(this);
                var $input = $('<input style="display: none;" type="radio" name="theme_customize_backend_modal-select-' + uniqueID + '"/>');
    ...
    update_style: function (enable, disable, reload) {
        ...
        this.$el.find('.f_color_palette_loading').show();
        ...
        return ajax.jsonRpc('/web/theme_customize_backend', 'call', {
            ...
            return linksLoaded.then(function () {
                ...
                self.$el.find('.f_color_palette_loading').hide();
            });
        });
    },
    ...
    click: function (event) {
        if (!$(event.target).closest("#theme_customize_backend_modal > *").length) {
            this.close();
        }
    },
    close: function () {
